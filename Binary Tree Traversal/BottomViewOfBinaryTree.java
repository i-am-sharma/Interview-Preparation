...
class Pair<U, V> {
 ...
 class BottomViewOfBinaryTree {
    ...
    public static void printBottomView (TreeNode root, HashMap<Integer, Pair <Integer, Integer>> map, int dist, int height){
        if (root == null) return;
        ...
        printBottomView(root.left, map, dist-1, height+1);
        printBottomView(root.right, map, dist+1, height+1);
